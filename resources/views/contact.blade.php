...
@section('content')
    ...
    <style>
        ...
        .form-clt textarea:focus {
            border-color: #B69974 !important;
            box-shadow: 0 0 0 0.2rem rgba(182, 153, 116, 0.25) !important;
            transition: all 0.3s ease;
        }
                ...
                <div class="row g-4 align-items-center">
                        ...
                        <div class="contact-left-items">
                            <div class="contact-info-area-2">
                                <div class="contact-info-items mb-4">
                                    ...
                                    <div class="content">
                                        <p>Hubungi Kami (WhatsApp)</p>
                                        <h3>
                                            <a
                                                href="https://api.whatsapp.com/send/?phone=62817333977&text&type=phone_number&app_absent=0">0817333977</a>
                                        </h3>
                                    </div>
                                </div>
                                <div class="contact-info-items mb-4">
                                    ...
                                    <div class="content">
                                        <p>Email Kami</p>
                                        <h3>
                                            <a href="mailto:gbtbethlehem@gmail.com">gbtbethlehemofficial@gmail.com</a>
                                        </h3>
                                    </div>
                                </div>
                            ...
                            <div class="video-image">
                                <img src="{{ asset('assets/img/komunitas/footer.jpg') }}" alt="GBT Bethlehem">
                                <div class="video-box">
                                    <a href="https://www.youtube.com/watch?v=6TFkL-R3XwI" target="__blank"
                    ...
                    <div class="col-lg-6">
                        <div class="contact-content">
                            <h2>Bergabunglah dengan GBT Bethlehem</h2>
                            <p>
                            ...
                            <form id="submit-to-google-sheet" class="contact-form-items" action="">
                                ...
                                @if (session('success'))
                                    <div class="alert alert-success alert-dismissible fade show" role="alert">
                                        <strong><i class="fa-solid fa-check-circle me-2"></i> Berhasil!</strong>
                                        {{ session('success') }}
                                ...
                                <div class="row g-4">
                                    <div class="col-lg-6 wow fadeInUp" data-wow-delay=".3s">
                                        <div class="form-clt">
                                            <span><i class="fa-solid fa-user me-1"></i> Nama Lengkap*</span>
                                            <input type="text" name="Nama" id="name" placeholder="Nama Lengkap"
                                                class="@error('name') is-invalid @enderror" value="{{ old('name') }}">
                                            @error('name')
                                                <div class="invalid-feedback"
                                                    style="display: block; color: #dc3545; margin-top: 5px; font-size: 14px;">
                                    ...
                                    <div class="col-lg-6 wow fadeInUp" data-wow-delay=".4s">
                                        <div class="form-clt">
                                            <span><i class="fa-solid fa-calendar-days me-1"></i> Tempat Tanggal
                                                Lahir*</span>
                                            <input type="text" name="Tanggal Lahir" id="birth_info"
                                                placeholder="Contoh: Surabaya, 01 Januari 1990"
                                                class="@error('birth_info') is-invalid @enderror"
                                                value="{{ old('birth_info') }}">
                                            @error('birth_info')
                                                <div class="invalid-feedback"
                                                    style="display: block; color: #dc3545; margin-top: 5px; font-size: 14px;">
                                                    <i class="fa-solid fa-exclamation-circle me-1"></i> {{ $message }}
                                    ...
                                    <div class="col-lg-6 wow fadeInUp" data-wow-delay=".6s">
                                        <div class="form-clt">
                                            <span><i class="fa-solid fa-phone me-1"></i> Nomor Telepon*</span>
                                            <input type="text" name="Nomor Telepon" id="phone"
                                                placeholder="Nomor telepon" class="@error('phone') is-invalid @enderror"
                                                value="{{ old('phone') }}">
                                            @error('phone')
                                                <div class="invalid-feedback"
                                                    style="display: block; color: #dc3545; margin-top: 5px; font-size: 14px;">
                                    ...
                                    <div class="col-lg-6 wow fadeInUp" data-wow-delay=".7s">
                                        <div class="form-clt">
                                            <span><i class="fa-solid fa-envelope me-1"></i> Email (Opsional)</span>
                                    ...
                                    <div class="col-lg-12 wow fadeInUp" data-wow-delay=".8s">
                                        <div class="form-clt">
                                            <span><i class="fa-solid fa-message me-1"></i> Pesan*</span>
                                            <textarea name="Message" id="message"
                                                placeholder="Tuliskan tujuan pendaftaran (jemaat/pelayanan divisi) dan informasi tambahan"
                                                class="@error('message') is-invalid @enderror" rows="5">{{ old('message') }}</textarea>
                                            @error('message')
                                                <div class="invalid-feedback"
                                                    style="display: block; color: #dc3545; margin-top: 5px; font-size: 14px;">
                                                    <i class="fa-solid fa-exclamation-circle me-1"></i> {{ $message }}
                                    ...
                                    <div class="col-lg-7 wow fadeInUp" data-wow-delay=".9s">
                                        <button type="submit" class="theme-btn">
                                            Kirim Pendaftaran <i class="fa-solid fa-paper-plane ms-2"></i>
                                        </button>
                                    </div>
                                </div>
                            </form>
        ...
        <div class="container">
            <div class="row mb-4">
                <div class="col-12 text-center">
                    <h2>Lokasi Kami</h2>
                    <p>Kunjungi GBT Bethlehem di lokasi berikut</p>
                </div>
            </div>
            <div class="map-items">
                <div class="googpemap">
                    <iframe
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3581.0696717901815!2d112.7228669!3d-7.3302057000000005!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2dd7fbbf132f492b%3A0x9e8a0383263da883!2sGBT.%20Bethlehem%20Surabaya!5e1!3m2!1sen!2sid!4v1751870441715!5m2!1sen!2sid"
...
@push('scripts')
    <script>
        const scriptURL =
            'https://script.google.com/macros/s/AKfycbxXH7I4et_PXLdpTSMWKKSPpJsEGakSSmPCk0ZDqirBIwNAjXCs3KmSJpnE-6DL9Jd9vA/exec';
        const form = document.getElementById('submit-to-google-sheet');

        form.addEventListener('submit', e => {
            e.preventDefault(); // mencegah reload atau pindah halaman
            ...
            fetch(scriptURL, {
                ...
                .then(response => {
                    // tampilkan pesan sukses di halaman kamu
                    alert("Pendaftaran berhasil dikirim!");
                    form.reset(); // reset form jika ingin
                })
                .catch(error => {
